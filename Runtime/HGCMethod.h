...
// all arguments MUST BE WRAPPED in HGCARG, e.g.:
// [method sendToTarget:target, HGCARG(arg1), HGCARG(arg2)]
#define HGC_ARG_MAGIC_COOKIE 0xdeadbeef
#define HGCARG(expr) HGC_ARG_MAGIC_COOKIE, @encode(__typeof__(expr)), (__typeof__(expr) []){ expr }
